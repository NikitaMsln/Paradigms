 ...
 * <br/>
 * Let <b>orderLike</b>{@code (array1, array2) = array1 in array2
 *      && i < j where i,j in array1 => array2[array1^(-1)[i]] < array2[array1^(-1)[j]]}
...
public interface Queue {
     ...
     * <br>
     * Post: {@code a' in a && OR[predicate.test(i) for i in a'] == false
     ...
     * Pred: {@code predicate != null}
     * <br>
     * Post: {@code a' in a && AND[predicate.test(i) for i in a'] == true
